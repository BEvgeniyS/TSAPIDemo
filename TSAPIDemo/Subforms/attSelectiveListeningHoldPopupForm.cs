...
namespace TSAPIDemo
{
    public partial class attSelectiveListeningHoldPopupForm : Form
    {
        internal Csta.ConnectionID_t[] _conns;
        internal mainForm _parent;

        public attSelectiveListeningHoldPopupForm(Csta.ConnectionID_t[] conns)
        {
            this._conns = conns;
            InitializeComponent();
        ...
        private void goButton_Click(object sender, EventArgs e)
        {
            ...
            Acs.RetCode_t rc;
            if (this.blockAllCheckBox.Checked)
                rc =  Att.attSelectiveListeningHold(this._parent.privData, checkedButton1.Connection, true, checkedButton1.Connection);
            else
                rc = Att.attSelectiveListeningHold(this._parent.privData, checkedButton1.Connection, false, checkedButton2.Connection);
            this._parent.Log("attSelectiveListeningHold result = " + rc._value);
            ...
            {
                MessageBox.Show("attSelectiveListeningHold Failed. Error was: " + eventBuf.evt.cstaConfirmation.universalFailure.error);
            }
        }
    ...
    public class RadioButtonConn : RadioButton
    {
